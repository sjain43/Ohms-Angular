...
let ActivityControlComponent = class ActivityControlComponent {
...
ActivityControlComponent.ctorParameters = () => [
...
let RegControlComponent = class RegControlComponent {
    ...
    OnSubmit() {
        ...
        this.register.doRegistration(this.reg).subscribe(value => {
            this.id = value;
...
RegControlComponent.ctorParameters = () => [
